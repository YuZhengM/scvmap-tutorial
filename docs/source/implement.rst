...
through the Docker image `mysql:8.0.32 <https://hub.docker.com/layers/library/mysql/8.0.32/images/>`_.
To enhance system performance, we have introduced the `Redis <https://redis.io/>`_ 6.2.11-alpine Docker container image
as a caching mechanism. The frontend is developed using the `Vue <https://vuejs.org/>`_ 3.2.4 framework within
...
`CanvasXpress <https://canvasxpress.org/>`_ 38.4.1 are used for graph visualization.
